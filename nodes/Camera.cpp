...
//      Att_subscriber_ = this->create_subscription<std_msgs::msg::Bool>(rgbcam_topic_name+"/attribute" , 10 ,std::bind(&CameraPublisher::AttSubCallback, this, std::placeholders::_1));
...
//void CameraPublisher::AttSubCallback(const std_msgs::msg::Bool::SharedPtr msg) {
